...
function LinkedInIcon({ className = "h-[18px] w-[18px]" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.5 8h4V24h-4V8zm7.5 0h3.8v2.2h.05c.53-1 1.83-2.2 3.77-2.2 4.03 0 4.78 2.65 4.78 6.1V24h-4v-7.1c0-1.7-.03-3.9-2.38-3.9-2.38 0-2.74 1.86-2.74 3.78V24h-4V8z" />
    </svg>
  );
}
...
/** Minimal social icon row. Premium, monochrome, hover to Lumive Light teal. */
export function Socials({
  ...
  const styles =
    tone === "dark"
      ? "text-cloud/70 hover:text-lumive-light"
    ...
    <div className={`flex items-center gap-4 ${className}`}>
      {ITEMS.map(({ label, href, Icon }) => (
        <a
          ...
          aria-label={`Follow Lumive AI on ${label}`}
          title={`Follow Lumive AI on ${label}`}
          className={`focus-brand transition-colors ${styles}`}
        >
          <Icon />
        </a>
      ))}
